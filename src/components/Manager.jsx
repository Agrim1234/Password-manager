...
const Manager = () => {
    ...
    const deletePassword = async (id) => {
        ...
        if (c) {
            ...
            // let reqGet = await fetch("http://localhost:3000/");
            // let passwords = await reqGet.json();
            // setPasswordArray(passwords);
                                ...
                                return <tr key={index}>
                                    <td className='py-2 border border-white text-center'>
                                        <div className='flex items-center justify-center gap-4'>
                                            ...
                                            <div className='size-7 cursor-pointer flex items-center' onClick={() => { copyText(item.site) }}>
                                                <FaCopy />
                                            </div>
                                        </div>
                                    </td>
                                    <td className='py-2 border border-white text-center'>
                                        <div className='flex items-center justify-center gap-4'>
                                            ...
                                            <div className='size-7 cursor-pointer flex items-center' onClick={() => { copyText(item.username) }}>
                                                <FaCopy />
                                            </div>
                                        </div>
                                    </td>
                                    <td className='py-2 border border-white text-center'>
                                        <div className='flex items-center justify-center gap-4'>
                                            ...
                                            <div className='size-7 cursor-pointer flex items-center' onClick={() => { copyText(item.password) }}>
                                                <FaCopy />
                                            </div>
                                        </div>
                                    </td>
